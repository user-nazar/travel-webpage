(() => {
    ...
    (() => {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        console.log(spollersBlock, oneSpoller);
        ...
        function initSliders() {
            if (document.querySelector(".book-page__slider")) {
                const bookTumbs = new core(".book-page__slider-name", {
                    ...
                    lazy: true,
                    navigation: {
                        prevEl: ".book-page__left",
                        nextEl: ".book-page__right"
                    },
                    on: {}
                });
                new core(".book-page__slider", {
                    modules: [ Navigation, Autoplay, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".videos-page__slider")) new core(".videos-page__slider", {
                modules: [ Navigation, Autoplay, Keyboard, EffectCoverflow ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                speed: 800,
